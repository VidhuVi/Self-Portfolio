export const projects = [
  ...
  },
  {
    ...
    features: [
      ...
      "Master Workstream for actionable takeaways",
      "Contextual Global Chat across meeting histories"
    ]
  },
  {
    id: "law-sahayi",
    ...
    features: [
      ...
      "Intuitive web interface via Streamlit",
      "Extremely low-latency inference architecture"
    ]
  },
  {
    id: "rentease",
    ...
    features: [
      ...
      "Real-time state synchronization via expressive REST API",
      "Personalized Dashboard tracking active and historic rentals"
    ]
  },
  {
    id: "skylarks",
    ...
    features: [
      ...
      "Complex geometric analysis for target locking",
      "Precision navigation algorithms tailored for automated UAVs"
    ]
  }
];
