      ...
      <section id="about" className="py-24 px-8 md:px-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="lg:pl-12">
          ...
          <div className="flex gap-16 border-t border-gray-200 pt-8">
            ...
            {/* <Link to="https://echoes-by-vidhu.netlify.app/" className="group cursor-pointer">
              <p className="text-4xl font-black text-blue-600 mb-1 group-hover:text-gray-900 transition-colors">My</p>
              <p className="text-xs font-bold uppercase tracking-widest text-gray-500 group-hover:text-blue-600 transition-colors flex items-center gap-1 underline underline-offset-4 decoration-blue-600/40 group-hover:decoration-blue-600">Echoes →</p>
            </Link> */}
